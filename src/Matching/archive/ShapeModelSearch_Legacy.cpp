/**
 * @file ShapeModelSearch_Legacy.cpp
 * @brief ARCHIVED: Traditional AnglePyramid-based search methods
 *
 * This file contains the legacy search code that was replaced by LINEMOD.
 * Preserved for research and comparison purposes.
 *
 * Methods archived:
 * - SearchPyramid (gradient-direction-based coarse-to-fine search)
 * - SearchPyramidWithResponseMap (precomputed response map variant)
 * - SearchLevel (helper for pyramid refinement)
 *
 * @note To restore this functionality:
 * 1. Copy the methods back to ShapeModelImpl
 * 2. Add a conditional in FindShapeModel to call SearchPyramid vs SearchPyramidLinemod
 * 3. Ensure AnglePyramid and ResponseMap are included and available
 */
...
// =============================================================================
// ShapeModelImpl::SearchPyramid (LEGACY)
// =============================================================================
...
// =============================================================================
// ShapeModelImpl::SearchPyramidWithResponseMap (LEGACY)
// =============================================================================
...
// =============================================================================
// ShapeModelImpl::SearchLevel (LEGACY)
// =============================================================================
